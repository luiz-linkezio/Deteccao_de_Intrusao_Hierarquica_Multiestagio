...
def binary_distribution_threshold_search(y_true, y_pred_proba):
    ...
    for prob, classe in y_prob_true:
        ...
        if classe == 1: acc -= one_p # como o threshold esta acima do dado, ele sera categorizado incorretamente como 0
        else:           acc += one_p # como o threshold esta acima do dado, ele sera categorizado corretamente como 0
...
if __name__ == '__main__':
    ...
    print(binary_distribution_threshold_search(y,y_p))